...
public class VideoController {
	...
	public ResponseEntity<Map<String, Object>> videoView(@PathVariable("boardNo") Long boardNo, BoardDTO boardDTO) {
		
		Map<String, Object> response = new HashMap<>();
		
		service.videoDetailCount(boardNo);
		
		response.put("board", service.getVideoDetail(boardNo, boardDTO));
