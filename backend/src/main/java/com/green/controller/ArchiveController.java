...
public class ArchiveController {
	...
	public ResponseEntity<Map<String, Object>> archiveView(@PathVariable("boardNo") long boardNo, BoardDTO boardDTO) {
		
		Map<String, Object> response = new HashMap<>();
		
		service.archiveDetailCount(boardNo);
		
		response.put("board", service.getArchiveDetail(boardNo, boardDTO));
